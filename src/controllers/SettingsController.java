...
public class SettingsController implements MouseListener {
    ...
    public SettingsController(SystemView views){
        ...
        this.views.jLabelSettigns.addMouseListener(this);
    }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        }else if (e.getSource() == views.jLabelSettigns){
            views.jPanelSettigns.setBackground(new Color(152, 202, 63));
        }
    ...
    public void mouseExited(MouseEvent e) {
        if (e.getSource() == views.jLabelProducts){
            ...
            views.jPanelSettigns.setBackground(new Color(18, 45, 61));
        }
    }
